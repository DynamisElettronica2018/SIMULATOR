...
void Can_init() {
    ...
    CAN1SetMask(_CAN_MASK_B2, 0b11100000010, _CAN_CONFIG_MATCH_MSG_TYPE & _CAN_CONFIG_STD_MSG);
    CAN1SetFilter(_CAN_FILTER_B2_F1, 0b11000000010, _CAN_CONFIG_STD_MSG);
    //*/
