...
void dEbb_calibrateUp(void) {
    Can_writeByte(SW_EBB_ID, (unsigned char) EBB_CALIBRATE_UP);
}

void dEbb_calibrateDown(void) {
    Can_writeByte(SW_EBB_ID, (unsigned char) EBB_CALIBRATE_DOWN);
}

void dEbb_calibratePause(void) {
    Can_writeByte(SW_EBB_ID, (unsigned char) EBB_CALIBRATION);
}

void dEbb_calibrateStop(void) {
    Can_writeByte(SW_EBB_ID, (unsigned char) EBB_DAGO_OFFSET);
    dEbb_localValue = 0;
